            ...
            <div class="level">
              <div class="level-left">
                <div class="level-item">
                  <youtrack-logo v-if="to === 'youtrack'"/>
                </div>
                <div class="level-item">
                  <div class="has-text-weight-semibold has-text-info is-capitalized">{{name}}</div>
                </div>
              </div>
            </div>
          </div>
...
<script>
  import YoutrackLogo from './YoutrackLogo';
  export default {
    name: "actionForm",
    components: {YoutrackLogo},
